          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[11px] text-slate-500">
                  OCR scan &amp; store medical reports
                </div>
              </div>
            </div>
          </button>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <FolderLock className="w-4 h-4 text-[#0F8B8D]" />
          ...
          {documents.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              {documents.slice(0, 3).map((doc) => (
                <div
                  key={doc.id}
                  onClick={() => router.push('/patient/documents')}
                  className="p-3.5 rounded-xl border border-slate-200 hover:border-[#0F8B8D] bg-slate-50/50 hover:bg-white cursor-pointer transition-all space-y-1.5"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] text-slate-400">
                      {doc.documentDate || doc.uploadDate}
                    </span>
                  </div>
                  ...
                  <div className="text-[11px] text-slate-500 truncate">
                    {doc.hospitalName || doc.doctorName || 'District HQ Hospital'}
                  </div>
                </div>
              ))}
            </div>
            ...
            <p className="text-xs text-slate-500 py-2">
              No documents uploaded yet. Tap &quot;Upload Document&quot; above to store test reports.
            </p>
          )}
        </div>
